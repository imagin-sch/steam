...
<button style="margin-left:90;margin-top:20" type="button" class="btn btn-primary" onclick="javascrtpt:window.location.href='/new/label.php?game_id=<?php echo $game_id?>'">为游戏增加标签</button>
<button style="margin-left:90;margin-top:20" type="button" class="btn btn-danger" onclick="javascrtpt:window.location.href='/new/xiajia.php?game_id=<?php echo $game_id?>'">下架该游戏</button>
<button style="margin-left:90;margin-top:20" type="button" class="btn btn-warning" onclick="javascrtpt:window.location.href='/new/discount.php?game_id=<?php echo $game_id?>'">为该游戏打折</button>
<button style="margin-left:90;margin-top:20" type="button" class="btn btn-info" onclick="javascrtpt:window.location.href='/new/kfs.php'">返回</button>
